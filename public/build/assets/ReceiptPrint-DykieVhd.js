import{c as e,d as t,n,o as r,t as i}from"./app-BRyhfRXd.js";import{t as a}from"./printer-C4kfleXc.js";import{n as o,r as s,t as c}from"./printPriceVisibility-CssKXNd_.js";import{a as l,i as u,n as d,r as f,t as p}from"./ThermalPrintButton-Dwa2D-XK.js";var m=t(e(),1),h=i(),g=e=>`Rp ${Number(e||0).toLocaleString(`id-ID`)}`;function _({sale:e,shop:t}){let[i,l]=(0,m.useState)(()=>c());(0,m.useEffect)(()=>{o(i)},[i]),(0,m.useEffect)(()=>{if(new URLSearchParams(window.location.search).get(`print`)===`1`){let e=setTimeout(()=>window.print(),400);return()=>clearTimeout(e)}},[]);let u={cash:`Tunai`,transfer:`Transfer Bank`,qris:`QRIS`}[e.payment_method]||e.payment_method,d=e.items??[];return(0,h.jsxs)(h.Fragment,{children:[(0,h.jsx)(n,{title:`Nota ${e.receipt_number}`}),(0,h.jsx)(`style`,{children:`
                .receipt-print-shell {
                    min-height: 100vh;
                    background: #e8eef3;
