import{c as e,d as t,n,o as r,t as i}from"./app-Cmkvu5dt.js";import{t as a}from"./printer-CcRPQMhc.js";import{n as o,r as s,t as c}from"./printPriceVisibility-cPV2-7XV.js";import{a as l,i as u,n as d,o as f,r as p,t as m}from"./ThermalPrintButton-DONMZBYX.js";var h=t(e(),1),g=i(),_=e=>`Rp ${Number(e).toLocaleString(`id-ID`)}`;function v({sale:e,shop:t}){let[i,l]=(0,h.useState)(()=>c());(0,h.useEffect)(()=>{o(i)},[i]),(0,h.useEffect)(()=>{if(new URLSearchParams(window.location.search).get(`print`)===`1`){let e=setTimeout(()=>window.print(),400);return()=>clearTimeout(e)}},[]);let u={cash:`Tunai`,transfer:`Transfer Bank`,qris:`QRIS`}[e.payment_method]||e.payment_method,d=e.items??[];return(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(n,{title:`Nota ${e.receipt_number}`}),(0,g.jsx)(`style`,{children:`
                .receipt-print-shell {
                    min-height: 100vh;
                    background: #eef2f6;
